...
select  a.nome as Usuario, b.id_lista, d.titulo as Filmes  from usuario a
...
select a.nome as Usuario, b.id_lista, b.DATA_Criacao, d.titulo as Filme from usuario a
left join lista b on a.id_usuario = b.id_usuario
left join lista_conteudo c on b.id_lista = c.id_lista
left join filme d on c.id_filme = d.id_filme
